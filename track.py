...
# Test solution with image first
...
# STEP 6: Extract and visualize the segmentation mask.
segmentation_mask = detection_result.segmentation_masks[0].numpy_view()

# Normalize the mask to the range 0-255 and convert to a 3-channel image
